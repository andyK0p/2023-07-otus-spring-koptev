...
import ru.otus.spring.springshellquiz.service.impl.ConsoleQuizIOService;
...
class ConsoleQuizIOServiceTest {
    ...
    static class TestQuizIOServiceConfiguration {
        @Bean
        public QuizIOService ioService(LocalizationService service) {
            return new ConsoleQuizIOService(service);
        }
    }
