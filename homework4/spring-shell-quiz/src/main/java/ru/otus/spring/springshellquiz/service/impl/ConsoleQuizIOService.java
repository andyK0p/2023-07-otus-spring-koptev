...
import ru.otus.spring.springshellquiz.util.QuizUtils;
...
public class ConsoleQuizIOService implements QuizIOService {
    ...
    @Override
    public void printUnderageCheckNotice() {
        printText(localizationService.getMessage("ageInYears"));
    }

    @Override
    public String getAfterAgeCheckMessage() {
        return localizationService.getMessage("afterAgeCheck");
    }

    @Override
    public String getAgeCheckFailed() {
        return localizationService.getMessage("underageFail");
    }
